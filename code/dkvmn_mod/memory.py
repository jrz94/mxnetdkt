...
class DKVMNHeadGroup(object):
    ...
    def read(self, memory, control_input=None, read_weight=None):
        ...
        read_content = mx.sym.Reshape(data=mx.sym.batch_dot(read_weight, memory),
    ...
    def write(self, control_input, memory, write_weight=None):
        ...
        if write_weight is None:
            write_weight = self.addressing(control_input=control_input,
                                           memory=memory)  # Shape Shape (batch_size, memory_size)
